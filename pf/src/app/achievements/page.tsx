    ...
    <main className="container mx-auto px-4 pt-32 pb-16">
      ...
      <div className="relative border-l-2 border-periwinkle/30 ml-6 md:ml-0">
        {achievementsData.map((achievement, index) => {
          // Validates that the certificate link is filled out with a real address
          const hasCertificate = 
            achievement.certificateLink && 
            achievement.certificateLink.trim() !== '' && 
            !achievement.certificateLink.includes('-placeholder-') &&
            !achievement.certificateLink.includes('-link-here');
          ...
          return (
            <div key={index} className="mb-10 ml-8">
              ...
              {/* Dynamically rendered only if a valid certificate is attached */}
              {hasCertificate && (
                <a 
